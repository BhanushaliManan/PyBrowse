...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        logo = QLabel()
        logo.setPixmap(QPixmap(os.path.join('images', 'icon-128.png')))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action.setStatusTip("Find out more about PyBrowse")
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')),
                                  "PyBrowse Home Page", self)
        navigate_action.setStatusTip("Go to PyBrowse Homepage")
        navigate_action.triggered.connect(self.navigate_to_home)
        ...
        self.setWindowIcon(QIcon(os.path.join('images', 'icon-64.png')))
    ...
    def navigate_to_home(self):
        self.tabs.currentWidget().setUrl(QUrl("https://mananbhanushali.github.io/PyBrowse"))
